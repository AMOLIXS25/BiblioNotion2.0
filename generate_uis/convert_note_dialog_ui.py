...
################################################################################
## Form generated from reading UI file 'convert_note_dialog_ui.ui'
##
...
class Ui_ConvertNoteDialog(object):
    def setupUi(self, ConvertNoteDialog):
        if not ConvertNoteDialog.objectName():
            ConvertNoteDialog.setObjectName(u"ConvertNoteDialog")
        ConvertNoteDialog.resize(295, 159)
        self.verticalLayout = QVBoxLayout(ConvertNoteDialog)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.horizontalLayout = QHBoxLayout()
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.pdf_frame = QFrame(ConvertNoteDialog)
        ...
        self.txt_frame = QFrame(ConvertNoteDialog)
        ...
        self.quit_button = QPushButton(ConvertNoteDialog)
        self.quit_button.setObjectName(u"quit_button")

        self.verticalLayout.addWidget(self.quit_button)


        self.retranslateUi(ConvertNoteDialog)

        QMetaObject.connectSlotsByName(ConvertNoteDialog)
    # setupUi

    def retranslateUi(self, ConvertNoteDialog):
        ConvertNoteDialog.setWindowTitle(QCoreApplication.translate("ConvertNoteDialog", u"Convertir", None))
        self.label.setText(QCoreApplication.translate("ConvertNoteDialog", u"PDF", None))
        self.label_2.setText("")
        self.label_3.setText(QCoreApplication.translate("ConvertNoteDialog", u"TXT", None))
        self.label_5.setText("")
        self.quit_button.setText(QCoreApplication.translate("ConvertNoteDialog", u"Quitter", None))
    # retranslateUi
