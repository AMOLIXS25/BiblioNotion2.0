...
class SelectBookToRegisterNoteView(QMainWindow, Ui_SelectBookForNoteWindow):
    """SelectNoteForBookView classe"""
    def __init__(self, parent=None):
        ...
        self.book_storage = BookStorage()
        self.register_note_view = RegisterNoteView(parent=parent)
    ...
    def on_confirm_button_clicked(self):
        ...
        try:
            ...
            self.register_note_view.book_to_register_note = book_custom_widget_selected.book_model
            if not self.register_note_view.isVisible():
